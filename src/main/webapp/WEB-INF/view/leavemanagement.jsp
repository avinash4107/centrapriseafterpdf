			...
			<div class="row row-offcanvas row-offcanvas-left">
				...
				<div class="user-list" id="user_list">
					...
					<div class="user-table">
						...
						<div class="text-left">Leave Management</div>
						...
						<form class="form-horizontal" action="" method="post"
							...
							<div class="add-user-btn">
								<a type="button" class="btn btn-info" href="/applyLeave">Add
									Leaves</a>
							</div>
						...
						<div class="form-field">
							<table class='table table-hover table-bordered size'>
								...
								<tbody>
									<c:forEach items="${leavesInfo}" var="leaves">
										<tr>
											<td>${leaves.id}</td>
											<td>${leaves.employeeNumber}</td>
											<td>${leaves.month}</td>
